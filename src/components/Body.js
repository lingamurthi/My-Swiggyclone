...
const Body = () => {
  ...
  const fetchData = async () => {
    ...
    const data=await fetch('https://my-swiggybackend.onrender.com/api/restaurants')
    const json = await data?.json();
    //console.log(json?.data);

    const carouseldata=await fetch('https://my-swiggybackend.onrender.com/api/headercard')
